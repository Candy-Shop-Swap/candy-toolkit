...
const Logo: React.FC<LogoProps> = ({ isDark, ...props }) => {
  ...
  return (
    <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 26" xmlSpace="preserve" {...props}>
      <style>
        {
          ".prefix__st0{fill:#78ecff}.prefix__st1{fill:#6dd1e2}.prefix__st2{fill:#622066}.prefix__st3{fill:#ff73ef}.prefix__st4{fill:#ffe600}.prefix__st5{fill:#ff9e16}.prefix__st7{fill:#fff}.prefix__st8{fill:#e856de}.prefix__st9{fill:#ffe317}.prefix__st10{fill:#ffc7d4}.prefix__st11{fill:#fff19f}.prefix__st12{fill:#88e9ff}.prefix__st13{fill:#d4f9ff}.prefix__st15{fill:#ff99b4}"
        }
      </style>
      <switch>
        <g>
          ...
          <g>
            ...
            />
            <circle className="prefix__st7" cx={31.8} cy={13.2} r={0.1} />
          </g>
          <g>
            <path
              className="prefix__st7"
          ...
          <g>
            <circle className="prefix__st4" cx={24} cy={16.5} r={2.8} />
            <ellipse
          ...
          <g>
            <circle className="prefix__st2" cx={23.7} cy={13.3} r={0.2} />
            <circle className="prefix__st2" cx={24.3} cy={13.3} r={0.2} />
          </g>
          <g>
            <path
              className="prefix__st2"
          ...
          <g>
            <circle className="prefix__st2" cx={16.6} cy={7.3} r={0.2} />
            <circle className="prefix__st2" cx={32.9} cy={7.6} r={0.2} />
            <circle className="prefix__st2" cx={26.6} cy={1.2} r={0.2} />
            <circle className="prefix__st2" cx={33.5} cy={18.7} r={0.2} />
            <circle className="prefix__st2" cx={33.5} cy={18.3} r={0.1} />
            <circle className="prefix__st2" cx={32.3} cy={7.4} r={0.1} />
            <circle className="prefix__st2" cx={16.8} cy={6.9} r={0.1} />
            <circle className="prefix__st2" cx={16.9} cy={19.8} r={0.1} />
            <circle className="prefix__st2" cx={13.6} cy={13.9} r={0.2} />
          </g>
          <g>
            <text
