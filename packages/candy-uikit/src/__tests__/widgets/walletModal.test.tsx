...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c7:hover:not(:disabled):not(.candy-button--disabled):not(.candy-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c7:active:not(:disabled):not(.candy-button--disabled):not(.candy-button--disabled) {
      opacity: 0.85;
    }

    .c7:disabled,
    .c7.candy-button--disabled {
    ...
    .c12:hover:not(:disabled):not(.candy-button--disabled):not(.candy-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c12:active:not(:disabled):not(.candy-button--disabled):not(.candy-button--disabled) {
      opacity: 0.85;
    }

    .c12:disabled,
    .c12.candy-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
    ...
    .c15:hover:not(:disabled):not(.candy-button--disabled):not(.candy-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c15:active:not(:disabled):not(.candy-button--disabled):not(.candy-button--disabled) {
      opacity: 0.85;
    }

    .c15:disabled,
    .c15.candy-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
